...
const SkillSection = () => {
  return (
    <>
      <section className="section-block bg-slate-900 py-10 md:px-36 gap-5 sticky top-0">
        ...
        <div className="w-100 gap-8 mb-14">
          <div className="min-h-[70vh] px-2">
            {skills.map((skill, index) => (
              ...
              >
                <div className="min-w-[40vw] text-xl md:text-3xl font-bold">
                  <h3 className="">{skill.title}:</h3>
                </div>
                <div className="mt-3 md:mt-0">
                  <h3 className="text-xl md:text-3xl font-normal leading-10 tracking-wide">
